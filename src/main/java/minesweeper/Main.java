...
public class Main extends Application {
    ...
    public void start(Stage stage) {
        ...
        smilingImageView = new ImageView(smilingImage);
        ...
        gameWonProperty.addListener((observable, oldValue, newValue) -> {
            ...
            if (newValue) {
                ...
                //TODO animation game won (fireworks?)
    ...
    /**
     * Populate initially the Tile Pane with cells,
     * according the selected Game Mode
     * 
     * @param gameMode
     */
